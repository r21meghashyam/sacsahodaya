...
export default class Create extends Component{ 
  ...
  render(){
	  let {error,completed,article_id} = this.state;
	return (
    ...
    <ResponsiveContainer>
      <Container text style={{ marginTop: '7em' ,minHeight:700}}>
        ...
        <Form style={{padding:20}} onSubmit={this.onSubmit} error={Object.keys(error).length>0}>
          <Form.Field>
			<Form.Input fluid label='Article Title' placeholder='Article Title' error={Boolean(error.title)} name="title" onChange={this.onChange}/>
          </Form.Field>
	...
	<Icon name="align right"/>*/}
		  ...
		  {completed?'':<Button type='submit' id="postBtn">Post Article</Button>}
		  {completed?<Button as={Link} to={`/articles/${article_id}`} color="teal">View Article</Button>:''}
